...
input(">>Q1 - Derivative of 1+(1/2)*tanh(2x) by central difference method\n>> Press enter...")
...
input(">>Q2 - Numerical differentiation of the data in 'data.txt' file\n>> Press enter...")
...
input(">>Q4 - Plot of function E(x) =int_0^x exp(-t^2) dt (integrate with trapezoidal method\n>> Press enter...")
